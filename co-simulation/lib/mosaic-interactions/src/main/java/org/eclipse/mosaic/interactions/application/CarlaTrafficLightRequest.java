...
@Immutable
public final class CarlaTrafficLightRequest extends Interaction {

    private static final long serialVersionUID = 1L;

    public static final String TYPE_ID = createTypeIdentifier(CarlaTrafficLightRequest.class);

    public enum Action { UPDATE }
    ...
    public CarlaTrafficLightRequest(long time, Action action, String trafficLightId, String state, Double timerSeconds) {
        super(time);
        this.action = action;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(29, 59)
            .append(action)
    ...
    public boolean equals(Object obj) {
        ...
        CarlaTrafficLightRequest other = (CarlaTrafficLightRequest) obj;
