...
/**
 * All applications that implement some form of V2x communication are to
...
public interface CommunicationApplication extends Application {
     ...
     *
     * @param acknowledgement the acknowledgement object which contains the sent V2X
     *                        Message and the acknowledgement status.
     */
    ...
    /**
     * This method is called when an external message is received.
     *
     * @param externalMessage the received external message container.
     */
    default void onExternalMessageReceived(ExternalMessage externalMessage) {
    };
}
