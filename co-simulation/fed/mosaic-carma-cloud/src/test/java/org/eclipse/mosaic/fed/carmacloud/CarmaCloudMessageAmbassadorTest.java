...
public class CarmaCloudMessageAmbassadorTest {
    ...
    public void setup() throws IOException, NoSuchFieldException, InternalFederateException, IllegalValueException {
        ...
        // Create CarmaCloud registration
    ...
    public void testProcessTimeAdvanceGrant() throws InternalFederateException, IllegalValueException, NoSuchFieldException, SecurityException {
        //Test processTimeAdvanceGrant for CarmaCloud Registration
        ambassador.processTimeAdvanceGrant(100);
        // Verify received messages were attempted to be pulled from CarmaCloud Registration Receiver mock
        ...
        for (CarmaCloudRegistrationMessage registrationMessage : registrationMessages) {
            ...
            assertEquals(registrationMessage.getCarmaCloudId(), registration.getMapping().getName());
            assertTrue(
