...
public class CarmaMessengerRegistationBridgeReceiver implements Runnable{

    
    protected Queue<CarmaMessengerRegistrationBridgeMessage> rxQueue = new LinkedList<>();
    ...
    public void run() {
        ...
        while (running) {
            ...
            Gson gson = new Gson();
            CarmaMessengerRegistrationBridgeMessage parsedMessage = gson.fromJson(receivedPacket, CarmaMessengerRegistrationBridgeMessage.class);
    ...
    public List<CarmaMessengerRegistrationBridgeMessage> getReceivedMessages() {
        List<CarmaMessengerRegistrationBridgeMessage> output = new ArrayList<>();
