...
/**
 * Extension of the {@link SumoAmbassador} starting the GUI of SUMO instead of
 * the CLI.
 */
public class SumoGuiAmbassador extends SumoAmbassador {
    ...
    /**
     * Creates a new {@link SumoGuiAmbassador} object using the super constructor,
     * which loads the configuration from the ambassadorParameter.
     *
    ...
    public FederateExecutor createFederateExecutor(String host, int port, OperatingSystem os) {
        ...
        this.federateExecutor = new ExecutableFederateExecutor(this.descriptor,
                AbstractSumoAmbassador.getSumoExecutable("sumo-gui"), super.getProgramArguments(port));
