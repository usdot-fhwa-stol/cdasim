![GitHub Release](https://img.shields.io/github/v/release/usdot-fhwa-stol/cdasim) [![Tests](https://github.com/usdot-fhwa-stol/cdasim/actions/workflows/ci.yml/badge.svg?branch=develop)](https://github.com/usdot-fhwa-stol/cdasim/actions/workflows/ci.yml) ![Docker Pulls](https://img.shields.io/docker/pulls/usdotfhwastoldev/cdasim?label=Docker%20Pulls%20-%20cdasim) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=usdot-fhwa-stol_carma-simulation&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=usdot-fhwa-stol_carma-simulation) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/usdot-fhwa-stol/cdasim/blob/develop/README.md#license)
