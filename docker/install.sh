...
sudo apt-get install -y --allow-unauthenticated --no-recommends gcc-7 g++-7 python3.6 unzip tar python3.6-dev \
  ...
  wget vim nano xterm default-jdk sumo sumo-tools sumo-doc software-properties-common
